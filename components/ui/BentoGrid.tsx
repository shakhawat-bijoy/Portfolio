...
const CopyEmailButton = memo(() => {
  ...
  const handleCopy = useCallback(() => {
    const text = "shakhawatbijoy1@gmail.com";
...
export const BentoGridItem = memo(({
  ...
  const rightLists = useMemo(() => ["NextJS", "Python", "Git"], []);
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* Tech stack list div */}
          {id === 3 && (
            <TechStackList leftLists={leftLists} rightLists={rightLists} />
          )}

          {id === 6 && <CopyEmailButton />}
        </div>
      </div>
    </div>
  );
